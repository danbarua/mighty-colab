---
log:
2026-09-13: Default `sync` rewrites relative symlink text onto the private snapshot at copy time (`normpath`, no follow) so tar never walks the live source.
